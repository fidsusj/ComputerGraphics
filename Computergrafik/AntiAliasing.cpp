...
#pragma warning(disable:4996)
	...
	void readcloud(const char* filename);
	...
	{
		const char* filename = "C:\\Users\\D070497\\OneDrive - SAP SE\\DHBW\\Skripte\\5. Semester\\Computergrafik\\Übungen\\Materialien\\bones.txt";
		readcloud(filename);		// change this in case the point cloud is saved somewhere else.
		glutInit(&argc, argv);
	...
	void display(void)
	{
		...
		case ORTHO:
			...
			glLoadIdentity();
			glOrtho(-2 - zoff, 2 + zoff, -2 - zoff, 2 + zoff, -2 + 5, 2 + 5);
